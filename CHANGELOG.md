...
## [3.0.3](https://github.com/Boshen/criterion2.rs/compare/v3.0.2...v3.0.3) - 2026-03-08

### Other

- *(deps)* update rust crate tokio to v1.50.0 ([#151](https://github.com/Boshen/criterion2.rs/pull/151))
- *(deps)* update dependency rust to v1.94.0 ([#150](https://github.com/Boshen/criterion2.rs/pull/150))
- *(deps)* update rust crate tempfile to v3.26.0 ([#149](https://github.com/Boshen/criterion2.rs/pull/149))
- *(deps)* update rust crates ([#148](https://github.com/Boshen/criterion2.rs/pull/148))
- *(deps)* update dependency rust to v1.93.1 ([#147](https://github.com/Boshen/criterion2.rs/pull/147))
- *(deps)* update rust crates ([#146](https://github.com/Boshen/criterion2.rs/pull/146))
- *(deps)* update rust crate codspeed to v4.3.0 ([#145](https://github.com/Boshen/criterion2.rs/pull/145))
- *(deps)* update dependency rust to v1.93.0 ([#144](https://github.com/Boshen/criterion2.rs/pull/144))
- *(deps)* update rust crates ([#143](https://github.com/Boshen/criterion2.rs/pull/143))
- *(deps)* update rust crates ([#142](https://github.com/Boshen/criterion2.rs/pull/142))
- *(deps)* update rust crate tokio to v1.49.0 ([#141](https://github.com/Boshen/criterion2.rs/pull/141))
- *(deps)* update rust crates ([#140](https://github.com/Boshen/criterion2.rs/pull/140))
- *(deps)* update dependency rust to v1.92.0 ([#139](https://github.com/Boshen/criterion2.rs/pull/139))
- *(deps)* update dependency rust to v1.91.1 ([#138](https://github.com/Boshen/criterion2.rs/pull/138))
- *(deps)* lock file maintenance ([#136](https://github.com/Boshen/criterion2.rs/pull/136))
...
## [3.0.5](https://github.com/Boshen/criterion2.rs/compare/v3.0.4...v3.0.5) - 2026-09-20
...
- *(deps)* update rust crates ([#202](https://github.com/Boshen/criterion2.rs/pull/202))
- *(deps)* update dependency rust to v1.98.1 ([#201](https://github.com/Boshen/criterion2.rs/pull/201))
- *(deps)* update dependency rust to v1.98.0 ([#199](https://github.com/Boshen/criterion2.rs/pull/199))
- *(deps)* update rust crate futures to v0.3.34 ([#198](https://github.com/Boshen/criterion2.rs/pull/198))
- *(deps)* update swatinem/rust-cache action to v2.9.2 ([#197](https://github.com/Boshen/criterion2.rs/pull/197))
...
- *(deps)* drop anes in favor of inline ANSI escapes ([#179](https://github.com/Boshen/criterion2.rs/pull/179))
- *(deps)* drop walkdir in favor of std recursion ([#178](https://github.com/Boshen/criterion2.rs/pull/178))
- *(deps)* update rust crates ([#177](https://github.com/Boshen/criterion2.rs/pull/177))
- *(deps)* update taiki-e/install-action digest to 1ff94e9 ([#176](https://github.com/Boshen/criterion2.rs/pull/176))
- *(deps)* update github actions ([#175](https://github.com/Boshen/criterion2.rs/pull/175))
- *(deps)* update dependency rust to v1.96.0 ([#174](https://github.com/Boshen/criterion2.rs/pull/174))
- *(deps)* update taiki-e/install-action digest to 2b5ff36 ([#173](https://github.com/Boshen/criterion2.rs/pull/173))
- *(deps)* update rust crates ([#172](https://github.com/Boshen/criterion2.rs/pull/172))
- *(deps)* update taiki-e/install-action digest to 132b6d4 ([#171](https://github.com/Boshen/criterion2.rs/pull/171))
- *(deps)* update rust crate bpaf to v0.9.26 ([#170](https://github.com/Boshen/criterion2.rs/pull/170))
- *(deps)* update taiki-e/install-action digest to 9c69533 ([#169](https://github.com/Boshen/criterion2.rs/pull/169))
- *(deps)* update taiki-e/install-action digest to 6fb7e04 ([#168](https://github.com/Boshen/criterion2.rs/pull/168))
- *(deps)* update rust crate tokio to v1.52.3 ([#167](https://github.com/Boshen/criterion2.rs/pull/167))
- *(deps)* update taiki-e/install-action digest to 503e871 ([#166](https://github.com/Boshen/criterion2.rs/pull/166))
